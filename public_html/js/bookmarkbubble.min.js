...
google.bookmarkbubble.Bubble.prototype.showIfAllowedWhenLoaded=function(a){if(!this.isAllowedToShow_())return!1;var b=this,c=b.loadImg_=document.createElement("img");c.src=b.getIconUrl_();c.onload=function(){c.complete&&(delete b.loadImg_,c.onload=null,b.show_(),a&&a())};c.onload();return!0};google.bookmarkbubble.Bubble.prototype.setHashParameter=google.abstractMethod;google.bookmarkbubble.Bubble.prototype.hasHashParameter=google.abstractMethod;
...
google.bookmarkbubble.Bubble.prototype.build_=function(){var a=document.getElementById("jsBookmarkBubble");this.getIosVersion_()>=this.getVersion_(4,2)?document.getElementById("jsBookmarkBubble1").style.display="block":document.getElementById("jsBookmarkBubble2").style.display="block";document.getElementById("jsBookmarkBubbleClose").onclick=google.bind(this.closeClickHandler_,this);a.style.display="block";return a};
